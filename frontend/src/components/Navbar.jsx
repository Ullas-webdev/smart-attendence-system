...
import { Bluetooth, LogOut, GraduationCap, BookOpen } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="hidden sm:inline ml-2 text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full font-medium">
                BLE
              </span>
            </div>
          </div>
