  ...
  const handleSubmit = async(e)=>{
    ...
    try{
      ...
      if(form.role === 'student'){
        ...
        payload.bluetoothDeviceId = form.bluetoothDeviceId;
      }
              ...
              {form.role === 'student' && (
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    value={form.bluetoothDeviceId}
                    onChange={e=>setForm({...form,bluetoothDeviceId:e.target.value})}
                  />
                  <p className="text-xs text-gray-400 mt-1">
                    Your phone's BT MAC address or UUID
                  </p>
                </div>
              )}
